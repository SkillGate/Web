...
const BlogInfo = () => {
    ...
    return (
        ...
        <div className="container mx-auto">
            ...
            <div className="container mx-auto flex flex-wrap items-center text-center my-4">
                <div className="mb-10">
                    <h2 className="font-bold text-lg mb-10">Skills</h2>
                    <div className="flex flex-wrap mt-5">
                        {skilldata.map(skill => (
                            <div key={skill.skill_name} className="w-full sm:w-1/2 lg:w-1/3 p-2">
                ...
                <div className="mb-10 w-full">
                    <h2 className="font-bold text-lg mb-10">Recommendations</h2>
                    <div className="mt-5">
                        <div class="max-w-3xl mx-auto relative overflow-hidden">
                            <div class="relative">
