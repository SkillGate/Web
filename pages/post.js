...
const PostJob = () => {
    ...
    const onSubmit = async (data) => {
        ...
        setLoading(true);
        try {
            const {data: jobData, loading, error} = await addJob(
                actualData,
                user?.accessToken
            );
            console.log(jobData);
    ...
    return !loading ? (
        <>
            <ModelPopup isVisible={isModalVisible} title={"Job Posting Unsuccessfully!"} toggleVisibility={toggleModal}/>
            <ModelPopup isVisible={isModalVisibleSuccess} title={"Job Posting Success!"}
                    ...
                    <div className="relative">
                        ...
                        >
                            {logo ? (
                                ...
                                <div
                                    className="w-20 h-16 rounded-lg grid place-items-center left-10 -bottom-8 absolute border-2 border-dotted border-slate-400 dark:border-hover-color">
                        ...
                        {Array.from({length: responsibilitiesFields}, (_, index) => (
                            ...
                            >
                                <div className="flex-auto mb-4 lg:mb-0 items-center flex justify-center gap-4">
                                    <div
                                        className="form-input w-full sm:flex-1 relative items-center flex justify-center">
                                        <Controller
                        ...
                        <div>
                            ...
                            >
                                ...
                                <label htmlFor="education_job_post z-50">
                                    ...
                                    <button
                                        className="bg-primary text-white font-semibold text-sm rounded-full w-5 h-5 cursor-pointer ml-2 z-50">
                                        i
                                    </button>
                                    {showTooltip && (
                                        <div
                                            className="absolute bg-white text-gray-800 border border-primary shadow-lg dark:bg-gray-800 dark:text-white text-sm rounded p-2 absolute z-10 text-center mb-2">
                                            We use this input field data to display in job posting
                                            <div
                                                className="bg-gray-800 absolute bottom-full left-1/2 transform -translate-x-1/2"></div>
                                        </div>
                                    )}
                                </label>
                            </div>
                            ...
                            >
                                ...
                                <label htmlFor="experience_job_post">
                                    ...
                                    {showExperieneceTooltip && (
                                        <div
                                            className="absolute bg-white text-gray-800 border border-primary shadow-lg dark:bg-gray-800 dark:text-white text-sm rounded p-2 absolute z-10 text-center">
                                            We use this input field data to display in job posting
                                            <div
                                                className="bg-gray-800 absolute bottom-full left-1/2 transform -translate-x-1/2"></div>
                                        </div>
