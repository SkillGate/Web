...
const AwardPopup = ({ onClose, details }) => {
                ...
                <div className="flex-1 overflow-y-auto pr-10 pt-5">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="form-input w-full sm:flex-1 relative">
                            ...
                            />
                            <label htmlFor="jobrole">Award name</label>
                        </div>
                        <div className="form-input w-full sm:flex-1 relative">
                            <Controller
                                name="employeetype"
                            ...
                            />
                            <label htmlFor="employeetype">Organization name</label>
                        </div>
                        <div className="form-input w-full sm:flex-1 relative">
                            <Controller
                                name="companyname"
                            ...
                            />
                            <label htmlFor="companyname">Decsription of achievement</label>
                        </div>
                        <div className="form-input w-full sm:flex-1 relative">
                            <h2>Date</h2>
