                ...
                <div className="flex-1 overflow-y-auto pr-10 pt-5">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="form-input w-full sm:flex-1 relative">
                            ...
                            />
                            <label htmlFor="jobrole">Project title</label>
                        </div>
                        <div className="form-input w-full sm:flex-1 relative">
                            <Controller
                                name="employeetype"
                            ...
                            />
                            <label htmlFor="employeetype">Project domain</label>
                        </div>
                                ...
                                render={({ field: { onChange, value } }) => (
                                    <>
                                        <div className="mb-2">
                                            ...
                                            />
                                            <label htmlFor="computerscince" className="ml-[2rem]">I am currently working in this project</label>
                                        </div>
                                    </>
                                )}
                            />
                        ...
                        <div className="form-input w-full sm:flex-1 relative mt-8">
                            ...
                            />
                            <label htmlFor="companyname">Project overview</label>
                        </div>
