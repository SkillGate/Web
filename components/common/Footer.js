...
const Footer = () => {
  return (
    <div>
      <div className="px-[2%] md:px-[6%] mt-20 z-0 bg-white dark:bg-dark-main py-10">
        <footer>
        ...
        <section className="attribution pt-2 border-top-light">
          <a href="#" className="logo flex-center-center gap-1 my-3">
            <img
              src="https://res.cloudinary.com/midefulness/image/upload/v1694111827/SkillGate/logo_pxxasx.png"
              alt=""
              className="w-40 pb-8"
            />
          </a>
          <div className="border bg-gray-20" />
          <p className="text-center text-muted pt-10">
            Created By <span className="text-primary-light">SkillGate</span> |
            All Rights Reserved
          </p>
        </section>
      </div>
